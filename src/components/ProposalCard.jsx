...
function ProposalCard(props) {
  ...
  return (
    <div
      className={`bg-white p-4 rounded-lg flex-shrink-0 w-72 shadow-md border-l-4 hover:shadow-lg transition ${
        ...
        {isStudent ? (
          <button
            onClick={() => {
              ...
              alert(`PROPOSAL ${props.data.event} DELETED SUCCESSFULLY!!`);
            }}
          ...
          <div>
            <button
              onClick={() => {
                deleteProps(props.index);
                alert(`PROPOSAL ${props.data.event} REJECTED SUCCESSFULLY!!`);
              }}
              className="bg-[#FFB200] hover:bg-[#EB5B00] text-[#640D5F] px-3 py-1 text-sm rounded"
            >
              Reject Proposal
            ...
            <button
              onClick={() => {
                alert(`PROPOSAL ${props.data.event} ACCEPTED SUCCESSFULLY!!`);
                addEvent(props.data);
                deleteProps(props.index);
              }}
