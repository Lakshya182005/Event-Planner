  ...
  const initialData = [
    ...
    },
    {
      ...
      description: "A morning yoga class to start your day relaxed and energized.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A hands-on workshop where participants can explore their creativity with paint.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A night for students to showcase their musical or spoken-word talent.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "An exhibition showcasing the latest technology and innovations in various fields.",
      status: "Open for Registration",
    ...
    },
    {
      ...
      description: "A day filled with various athletic events and fun competitions.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A guided morning walk to capture beautiful landscapes and urban life.",
      status: "Scheduled",
    ...
    },
    {
      ...
      organizer: "Eco Club",
      description: "A rally to spread awareness on climate change and sustainable living.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "An outdoor movie screening under the stars with free popcorn.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "Fast-paced basketball matches with small teams and fun rewards.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "Aspiring founders pitch ideas to industry mentors and investors.",
      status: "Open for Registration",
    ...
    },
    {
      ...
      description: "Practice new languages with native speakers in a fun setting.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "Stargazing session and a talk on constellations and space missions.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "An opportunity for students to network with alumni over lunch.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "Learn the basics of 3D printing and create your first object.",
      status: "Scheduled",
    ...
    },
    {
      ...
      location: "Innovation Hub",
      organizer: "Entrepreneurship Cell",
      description: "A session with mentors to help guide students with startup ideas.",
      status: "Scheduled",
    ...
    },
    {
      ...
      location: "Room 401",
      organizer: "Film Club",
      description: "A screening of selected indie short films from student filmmakers.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A discussion on the effects of climate change and what can be done.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A bootcamp to kickstart your web development journey with HTML, CSS, and JS.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "An interactive training session to improve public speaking skills.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A celebration of diverse cuisines and cultures with food stalls.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A relaxing evening of poetry readings from students and faculty.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "Coaching session for startup founders to refine their pitches.",
      status: "Open for Registration",
    ...
    },
    {
      ...
      description: "A VR gaming night where students can experience the latest VR games.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "An introductory session on the concepts and technologies behind blockchain.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A day dedicated to cleaning and beautifying the campus grounds.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A workshop to learn about community engagement and building connections.",
      status: "Scheduled",
    ...
    },
    {
      ...
      description: "A workshop for students interested in creating their own mobile apps.",
      status: "Scheduled",
