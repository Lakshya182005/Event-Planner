    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl p-6 overflow-y-auto max-h-screen">
                <h2 className="text-2xl font-bold text-[#640D5F] mb-6">Add New Event</h2>
                <form className="space-y-4">
                    ...
                    <input type="datetime-local" ref={dateRef}name="date"className="w-full p-2 border-2 border-[#FFB200] rounded-md focus:outline-none focus:ring-2 focus:ring-[#EB5B00]"/>
                    ...
                    <textarea ref={descriptionRef} name="description" placeholder="Description" className="w-full p-2 border-2 border-[#FFB200] rounded-md focus:outline-none focus:ring-2 focus:ring-[#EB5B00] min-h-[100px]"/>
 

                    <div className="flex items-center space-x-4">
                        <div className="flex items-center">

                            <input type="radio" value="Scheduling" name="status" ref={schedulingRadioRef} defaultChecked className="text-[#D91656] focus:ring-[#EB5B00]"/>
